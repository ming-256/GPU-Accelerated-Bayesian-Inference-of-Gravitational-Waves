...
HET_BASELINE="${REPO_ROOT}/GW170817/Scripts/GW170817_heterodyned_1.py"
HET_FLATZ="${REPO_ROOT}/GW170817/Scripts/GW170817_heterodyned_2.py"
HET_VP250="${REPO_ROOT}/GW170817/Scripts/GW170817_heterodyned_3.py"
...
# After this script completes, run locally on the analysis box:
#
#   python Plots/reweight_dL_to_flat_z.py \
#       --input  Results/test_suite/s14__gw170817__imrphenomxas_nrtidalv3__baseline__seed0000/samples.csv \
