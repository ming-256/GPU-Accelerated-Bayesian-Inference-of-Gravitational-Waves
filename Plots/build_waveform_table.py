...
differs):
  IMRPhenomXAS_NRTidalv3 (primary)
      <- Results/test_suite/s14__gw170817__imrphenomxas_nrtidalv3__baseline__seed0000
         (lnZ parsed from that run's sampler.log)
  TaylorF2 (family check)
      <- Results/gwtc1_phasemarg/PhaseMarg_Heterodyned_TaylorF2_local_psd-gwtc1_ref-gwtc1_baseline.csv
         lnZ 486.90 +/- 0.10 from Results/logs/20260222_085308_baseline_TaylorF2.log

Output: Results/gwtc1_phasemarg/tableW_waveform.tex  (\input by main.tex)
...
TF_LNZ, TF_DLNZ = 486.90, 0.10  # Results/logs/20260222_085308_baseline_TaylorF2.log
